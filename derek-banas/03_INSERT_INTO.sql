...
SELECT NOW();
-- INSERT INTO can be provided with the column name(s) and the corresponding respective value(s) 
...
-- In case INSERT INTO is called without any column name, then values for all the columns should be provided
-- INSERT can be called once and the various rows provided in tuples consecutively
...
SELECT * FROM item;
-- ALTER purchase_order_number TYPE
